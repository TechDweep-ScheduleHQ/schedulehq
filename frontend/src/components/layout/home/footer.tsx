      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-20">
          ...
          <div className="mb-6 md:mb-0">
            <h3 className="text-lg font-semibold mb-2">ScheduleHQ</h3>
            <p className="text-sm text-black">
              Simplifying scheduling for businesses and individuals worldwide.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-black hover:text-white">Features</a></li>
              <li><a href="#" className="text-black hover:text-white">Pricing</a></li>
              <li><a href="#" className="text-black hover:text-white">Support</a></li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 text-center text-sm text-black">
          <p>&copy; {new Date().getFullYear()} ScheduleHQ. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
